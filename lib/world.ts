...
export const sugorokuNodes: SugorokuNode[] = [
  { id: 'rubber-01', label: 'ゴムの力 ①', grade: 3, theme: 'chikara', regionId: 'butsuri', x: 683, y: 599 },
  { id: 'rubber-02', label: 'ゴムの力 ②', grade: 3, theme: 'chikara', regionId: 'butsuri', x: 742, y: 599 },
  { id: 'rubber-03', label: 'ゴムの力 ③', grade: 3, theme: 'chikara', regionId: 'butsuri', x: 800, y: 599 },
  { id: 'rubber-04', label: 'ゴムの力 ④', grade: 3, theme: 'chikara', regionId: 'butsuri', x: 860, y: 599 },
  { id: 'wind-01', label: 'かぜの力 ①', grade: 3, theme: 'chikara', regionId: 'butsuri', x: 919, y: 599 },
  { id: 'light-01', label: 'ひかり ①', grade: 3, theme: 'hikari', regionId: 'butsuri', x: 919, y: 658 },
  { id: 'mirror-01', label: 'かがみ ①', grade: 3, theme: 'hikari', regionId: 'butsuri', x: 860, y: 658 },
  { id: 'sound-01', label: 'おと ①', grade: 3, theme: 'hikari', regionId: 'butsuri', x: 800, y: 658 },
  { id: 'magnet-01', label: 'じしゃく ①', grade: 3, theme: 'jishaku', regionId: 'butsuri', x: 742, y: 658 },
  { id: 'magnet-02', label: 'じしゃく ②', grade: 3, theme: 'jishaku', regionId: 'butsuri', x: 683, y: 658 },
  { id: 'circuit-01', label: 'でんきの とおり道', grade: 3, theme: 'denki', regionId: 'butsuri', x: 683, y: 717 },
  { id: 'current-01', label: '電流の はたらき', grade: 4, theme: 'denki', regionId: 'butsuri', x: 742, y: 717 },
  { id: 'pendulum-01', label: 'ふりこ ①', grade: 5, theme: 'chikara', regionId: 'butsuri', x: 800, y: 717 },
  { id: 'pendulum-02', label: 'ふりこ ②', grade: 5, theme: 'chikara', regionId: 'butsuri', x: 860, y: 717 },
  { id: 'emag-01', label: '電流が つくる磁力', grade: 5, theme: 'denki', regionId: 'butsuri', x: 919, y: 717 },
  { id: 'lever-01', label: 'てこ ①', grade: 6, theme: 'chikara', regionId: 'butsuri', x: 919, y: 776 },
  { id: 'lever-02', label: 'てこ ②', grade: 6, theme: 'chikara', regionId: 'butsuri', x: 860, y: 776 },
  { id: 'lever-03', label: 'てこ ③', grade: 6, theme: 'chikara', regionId: 'butsuri', x: 800, y: 776 },
  { id: 'elec-use-01', label: '電気の りよう', grade: 6, theme: 'denki', regionId: 'butsuri', x: 742, y: 776 },
  ...
  { id: 'chigaku-01', label: 'かげを うごかそう', grade: 3, theme: 'chigaku', regionId: 'chigaku', x: 365, y: 348 },
  { id: 'chigaku-02', label: 'たいようを うごかそう', grade: 3, theme: 'chigaku', regionId: 'chigaku', x: 429, y: 348 },
  { id: 'chigaku-03', label: 'ひなたを さがそう', grade: 3, theme: 'chigaku', regionId: 'chigaku', x: 493, y: 348 },
  { id: 'chigaku-04', label: 'たいようを さがそう', grade: 3, theme: 'chigaku', regionId: 'chigaku', x: 557, y: 348 },
  { id: 'chigaku-05', label: 'つきを うごかそう', grade: 4, theme: 'chigaku', regionId: 'chigaku', x: 557, y: 407 },
  { id: 'chigaku-06', label: 'つきを 見つけよう', grade: 4, theme: 'chigaku', regionId: 'chigaku', x: 493, y: 407 },
  { id: 'chigaku-07', label: 'せいざを 作ろう', grade: 4, theme: 'chigaku', regionId: 'chigaku', x: 429, y: 407 },
  { id: 'chigaku-08', label: 'ほしの 明るさ', grade: 4, theme: 'chigaku', regionId: 'chigaku', x: 365, y: 407 },
  { id: 'chigaku-09', label: 'くもを うごかそう', grade: 5, theme: 'chigaku', regionId: 'chigaku', x: 365, y: 466 },
  { id: 'chigaku-10', label: 'くもと 天気', grade: 5, theme: 'chigaku', regionId: 'chigaku', x: 429, y: 466 },
  { id: 'chigaku-11', label: '天気よほう', grade: 5, theme: 'chigaku', regionId: 'chigaku', x: 493, y: 466 },
  { id: 'chigaku-12', label: '台風の しんろ', grade: 5, theme: 'chigaku', regionId: 'chigaku', x: 557, y: 466 },
  { id: 'chigaku-13', label: 'ちそうを ほろう', grade: 6, theme: 'chigaku', regionId: 'chigaku', x: 557, y: 525 },
  { id: 'chigaku-14', label: 'かせきを ほろう', grade: 6, theme: 'chigaku', regionId: 'chigaku', x: 493, y: 525 },
  { id: 'chigaku-15', label: '火山を 作ろう', grade: 6, theme: 'chigaku', regionId: 'chigaku', x: 429, y: 525 },
  { id: 'chigaku-16', label: '地しんの 前と 後', grade: 6, theme: 'chigaku', regionId: 'chigaku', x: 365, y: 525 },
